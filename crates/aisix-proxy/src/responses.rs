...
async fn responses_to_target(
    ...
    if is_stream {
        ...
        if hold_back {
            ...
            // Model-generated bytes in `buf[..counted_upto]` (#513) — what
            // `max_buffer_bytes` caps; the SSE/JSON envelope is not counted.
            ...
            loop {
                ...
                held_content += crate::held_content::sse_frames(
