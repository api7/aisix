            ...
            move |comp: StreamCompletion| {
                ...
                crate::request_metrics::record_usage(
                    ...
                    crate::request_metrics::Tokens {
                        ...
                        cached: comp.cached_prompt_tokens,
                        cache_read: comp.cache_read_tokens,
                        cache_creation: comp.cache_creation_tokens,
                        spend_usd: 0.0,
    ...
    F: FnOnce(StreamCompletion) + Send + 'static,
{
    ...
    let inner = async_stream::stream! {
        ...
        // Model-generated bytes held under BufferFull, measured by
        // `held_content` (#513) — what `max_buffer_bytes` caps.
