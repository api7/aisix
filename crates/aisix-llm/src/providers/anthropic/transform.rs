...
fn openai_messages_to_anthropic(
    messages: &[crate::types::openai::ChatMessage],
...
fn system_message_to_blocks(
    message: &crate::types::openai::ChatMessage,
...
fn anthropic_blocks_to_openai_message(
...
) -> Result<crate::types::openai::ChatMessage> {
    ...
    Ok(crate::types::openai::ChatMessage {
        role: "assistant".into(),
...
mod tests {
    ...
    fn transform_request_hoists_system_and_maps_tools() {
        ...
        assert!(
            matches!(anthropic.system, Some(crate::types::anthropic::SystemPrompt::Text(ref s)) if s == "You are helpful.")
        );
        ...
        assert_matches!(
            ...
            Some(crate::types::anthropic::AnthropicToolChoice::Auto)
        );
        assert_eq!(
    ...
    fn transform_response_maps_tool_use_and_cached_tokens() {
        ...
        assert_matches!(
            ...
            Some(crate::types::openai::MessageContent::Text(text)) if text == "Let me check."
        );
    ...
    fn transform_request_rejects_unsupported_n_values() {
        ...
        assert_matches!(
            error,
            crate::error::GatewayError::Bridge(message)
