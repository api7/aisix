...
mod tests {
    ...
    impl NativeOpenAIResponsesSupport for DummyNativeProvider {
        ...
        fn transform_openai_responses_request(
            &self,
            _req: &crate::types::openai::responses::ResponsesApiRequest,
        ...
        fn transform_openai_responses_response(
            ...
            crate::types::openai::responses::ResponsesApiResponse,
        > {
        ...
        fn transform_openai_responses_stream_chunk(
            &self,
            _raw: &str,
            _state: &mut crate::traits::OpenAIResponsesNativeStreamState,
        ) -> crate::error::Result<
            Vec<crate::types::openai::responses::ResponsesApiStreamEvent>,
        > {
            Ok(vec![])
        }
    }
    ...
    impl ChatFormat for DummyFormat {
        ...
        fn to_hub(
            _req: &Self::Request,
        ) -> crate::error::Result<(ChatCompletionRequest, BridgeContext)> {
            unreachable!("not used in this test")
        }
        ...
        fn from_hub_stream(
            ...
            _state: &mut Self::BridgeState,
            _ctx: &BridgeContext,
        ) -> crate::error::Result<Vec<Self::StreamChunk>> {
            Ok(vec![])
        }

        fn transform_native_stream_chunk(
            _provider: &dyn crate::traits::ProviderCapabilities,
            _raw: &str,
