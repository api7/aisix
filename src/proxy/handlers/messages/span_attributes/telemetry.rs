...
pub(in crate::proxy::handlers::messages) fn request_span_properties(
...
pub(in crate::proxy::handlers::messages) fn response_span_properties(
...
pub(in crate::proxy::handlers::messages) fn chunk_span_properties(
