...
<img src="https://static.api7.ai/uploads/2026/03/31/JoOfEAtE_architecture_std.svg" alt="AISIX Architecture Diagram" style={{width:'100%', maxWidth:'800px', margin:'20px auto', display:'block'}} />
